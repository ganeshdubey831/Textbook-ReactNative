    ...
    render() {
        return (
            <View style={{ width: "49%", height: 205, borderColor: "gray", borderWidth: 1, marginVertical: 5, marginHorizontal: 1, borderRadius: 10, backgroundColor: "white" }}>
                <TouchableOpacity onPress={this.props.actions}>
                    <View style={{
                    ...
                    <View>
                        <Text style={{ color: "black", fontSize: 13, fontWeight: "bold", alignSelf: "center", marginTop: 10 }}>{this.props.std}</Text>
                        <Text style={{ color: "gray", fontSize: 10, fontWeight: "bold", alignSelf: "center", marginTop: 10 }}>list of available books</Text>
                    </View>
                </TouchableOpacity>
            </View>
        );
